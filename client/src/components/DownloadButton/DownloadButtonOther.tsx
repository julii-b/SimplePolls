...
/**
 * A button to show the install prompt for non-Apple devices.
 * 
 * @returns {JSX.Element} The rendered button component.
 */
const DownloadButtonOther = (): JSX.Element => {
  ...
  if (installPrompt) { // Render button only if installPrompt is available
    return (
      <>
        <button // Button to show install prompt
...
export default DownloadButtonOther;